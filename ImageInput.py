...
class ImageInput():
    #class dealing with User Image input.
    #the methods provided are finalized to process the image and return the text contained in it.
    ...
    def get_text_processed_image(self):
    ...
    def plot_preprocessed_image(self):
        image = restoration.denoise_tv_chambolle(self.image, weight=0.21)
        thresh = threshold_otsu(image)
