...
class OcrData():
    ...
    def perform_grid_search_cv(self, model_name):
        #given a labeled train set (X_train, y_train) and a model_name among the ones set by the 
        #set_models method, returns the best model out of all  parameters combinations using the specified algorithm
    ...
    def generate_best_hog_model(self):
        #given the best parameters out of grid search returns best model on all train set using Pipeline(hog + linearsvc).  
    ...
    def merge_cifar(self):
        
        cifar = Cifar('/Users/alexandre/Projects/CharacterRecognition/configCifar.py')
        text  = OcrData('/Users/alexandre/Projects/CharacterRecognition/configText.py')
...
class HOGFeatures(BaseEstimator):
    #This class implements the Histogram Of Gradients feature
